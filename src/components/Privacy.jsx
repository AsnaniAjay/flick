    ...
    <article className="max-w-4xl mx-auto px-4 py-14 font-ibm">
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          <p className="text-gray-800 leading-relaxed text-sm md:text-base font-normal">
            The website “www.growthschool.io”{" "}
            <span className="font-medium">(“Website”)</span> is owned and
            operated by Sisinty Private Limited{" "}
            <span className="font-medium">(“Company”)</span>. [The Company is
            ...
            brochures made available to you under the web page for each specific
            course on our Website (“Services”).]
          </p>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            This privacy policy{" "}
            <span className="font-medium">(“Privacy Policy”)</span> sets out the
            privacy practices of the Company with respect to the usage of the
            Website and any other platforms that may be made available to you by
            the Company, in the future including, but not limited to, mobile
            applications and electronic devices in connection with our Services.
          </p>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            This document is published in accordance with the provisions of the
            Information Technology Act, 2000 and the rules made thereunder that
            require publishing the rules and regulations, privacy policy on an
            online portal of the Company. We request you to go through this
            Privacy Policy carefully before you decide to access the Website and
            avail the Services.
          </p>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            For the purposes of this Privacy Policy, the words{" "}
            <span className="font-medium">“us,” “we,” and “our”</span> refer to
            the Company and all references to{" "}
            <span className="font-medium">“you,” “your” or “user,”</span> as
            applicable, means the person who accesses or uses the Website and
            avails the Services in any manner or capacity.
            <br /> The protection and security of your personal information is
            our top priority and we have taken all reasonable measures to
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            information under the concerned Terms of Use available at{" "}
            <a
            ...
            , you agree to the terms of this Privacy Policy. You also expressly
            consent to our use and disclosure of your Personal Information (as
            defined below) in the manner prescribed under this Privacy Policy
            and further signify your agreement to this Privacy Policy. If you do
            not agree to this Privacy Policy, kindly do not use our Services and
            the Website, or share any of your information in any manner
            whatsoever with us.
          </p>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Collection of Information</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            We may collect and process information from you, through your access
            and use of the Website and Services. We may collect and process
            personal information provided by you, including but not limited to
            any information that identifies or can be used to identify, contact,
            or locate you, such as your name, address, email address, phone
            number, gender, photograph, date of birth, bank account details,
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            multiple users log in from the same device. This may include network
            and communication information, such as your IP address or phone
            number, and other information about things like your internet
            service, operating system, location, the type (including
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            receive depends on which services you authorize and any options that
            are available.
          </p>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            Use of the Information for Services
            <br /> The primary goal of the Company in collecting the Personal
            Information is to enable access to and use of the Website and
            Services by you. We may use the Personal Information provided by you
            in the following ways:
            <br /> To provide access to and use of the Website;
          </p>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            related entities in connection with the operation and management of
            the Website and Services in accordance with applicable laws.
          </p>
        </section>

        {/* Pricing Section */}
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Cookies and IP Address</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            Cookies are small portions of information saved by your browser onto
            your computer or mobile (“Cookies”). Cookies are used to record
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            availability and functionality of the Website. You may not decline
            web beacons. However, they can be rendered ineffective by declining
            all cookies or by modifying your web browser’s settings to notify
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Sharing of Information</h2>
          <h3 className="text-xl font-medium">Sharing</h3>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            specific services agreed to be provided by such third party.
          </p>
          <h3 className="text-xl font-medium">Targeted Advertising</h3>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
          ...
          <h3 className="text-xl font-medium">Regulatory Disclosures</h3>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
          ...
          <h3 className="text-xl font-medium">Referrals</h3>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            When you e-mail/message a Service available on the Website to a
            friend, you and your friend’s names and e-mail addresses/numbers are
            ...
            friends’ e-mail addresses will only be used for this purpose unless
            permission is otherwise granted.
          </p>
          <h3 className="text-xl font-medium">Link to Third Party Websites</h3>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Security of Information</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            in transmission, unauthorised third-party access or other acts of
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Exclusion</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            paragraph 1 above on “Collection of Information” and governed by the
            terms of the Terms of Use available at Terms & Conditions. This
            Privacy Policy will not apply to any information available in the
            public domain and unsolicited information provided by you through
            the Website and Services or through any other means. This includes,
            but is not limited to, information posted on any public areas of the
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Right to withdraw consent</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            hi@growthschool.io. If you withdraw your consent, we will stop
            processing the relevant Personal Information except to the extent
            that we have other grounds for processing such Personal Information
            under applicable laws. We will respond to your request within a
        ...
        <section className="space-y-4">
          ...
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            ...
            fulfil the purposes for which it was collected and as permitted by
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Right to Correction</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            The Website allows users access to their Personal Information and
            allows them to correct, amend or delete inaccurate information. You
            are responsible for maintaining the accuracy of the Personal
            Information you submit to us, such as your contact information
            provided as part of account registration. We rely on you to disclose
            all relevant and accurate information and to inform the Company of
            any changes. If you wish to make a request to correct or update your
            Personal Information, you may submit your request by sending an
            email to [insert relevant email address]. We shall not be liable for
            the accuracy or competency of any information that you have shared
            with us.
          </p>
        </section>
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Opt-out Procedures</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Notification of Changes</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-medium">Grievance Redressal</h2>
          <p className="text-gray-800 leading-relaxed text-sm md:text-base">
            If you wish to raise a query or complaint with us, please contact
            our Grievance Officer (contact details set out below) who shall
            acknowledge your complaint within 24 (twenty four) hours from the
            time of receipt of such complaint. Kindly note that once your
